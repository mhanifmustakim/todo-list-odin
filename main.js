...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "*,\n*::before,\n*::after {\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n    font-size: inherit;\n    color: inherit;\n}\n\n:root {\n    --header-color: #1F3541;\n    --footer-color: #5289B5;\n    --bg-color: #AFD8F2;\n    --nav-color: #cee6f5;\n    --custom-white: #EDF2F3;\n    --fade-color: #505050;\n    --red: #ff6e6e;\n    --green: #bada55;\n    font-size: 16px;\n    font-family: \"Roboto\", sans-serif;\n}\n\nli::marker {\n    content: none;\n}\n\n.icon {\n    width: 1em;\n    height: 1em;\n}\n\n.display-none {\n    display: none !important;\n}\n\n.text-bold {\n    font-weight: bold;\n}\n\n.text-center {\n    text-align: center;\n}\n\n.text-fade {\n    color: var(--fade-color);\n}\n\n.float-right{\n    float: right;\n}\n\n#page-container {\n    width: 100vw;\n    min-height: 100vh;\n    background-color: var(--bg-color);\n    display: grid;\n    grid-template: 4rem 1fr 2rem / 1fr;\n}\n\n#page-header,\n#page-footer {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    color: var(--custom-white);\n}\n\n#page-header {\n    background-color: var(--header-color);\n    justify-content: space-between;\n    padding: 0 1rem;\n    font-size: 1.5rem;\n}\n\n#nav-dropdown {\n    background-color: var(--header-color);\n    outline: none;\n    border: none;\n}\n\n#nav {\n    grid-area: nav;\n    background-color: var(--nav-color);\n    padding: 1rem;\n    display: flex;\n    flex-direction: column;\n    gap: 1rem;\n    font-size: 1.2rem;\n}\n\n#nav header {\n    font-size: 1.3em;\n    font-weight: bold;\n    padding-bottom: 1rem;\n}\n\n#nav ul>li {\n    padding: 0.5rem;\n    border-radius: 0.5em;\n    cursor: pointer;\n    display: grid;\n    align-items: center;\n    justify-items: start;\n    grid-template-columns: auto 1fr auto;\n    gap: 0.5rem;\n}\n\n#nav button.delete-btn {\n    float: right;\n    background-color: transparent;\n    border: none;\n    color: var(--header-color);\n    font-size: 0.9rem;\n    font-weight: bold;\n    padding: 0.2em 0.3em;\n    border-radius: 0.2em;\n}\n\n#nav ul>li.active {\n    font-weight: bold;\n    background-color: var(--bg-color);\n}\n\n#add-project {\n    cursor: pointer;\n}\n\n#add-project-form {\n    display: grid;\n    grid-template-columns: 1fr 1fr;\n    grid-template-rows: 1fr 1fr;\n    gap: 0.5rem;\n}\n\n#add-project-form>* {\n    border-radius: 0.5em;\n}\n\n#add-project-form>input {\n    grid-area: 1 / 1 / 1 / -1;\n    padding: 2px 0;\n    padding-left: 1ch;\n}\n\n#add-project-form>button {\n    padding: 0.5rem 0;\n    font-weight: bold;\n}\n\n#add-project-btn {\n    background-color: var(--green);\n}\n\n#cancel-project-btn {\n    background-color: var(--red);\n}\n\n#main {\n    display: grid;\n    padding: clamp(1rem, 5vw, 3rem);\n    grid-template: auto 1fr / 1fr;\n    gap: 1rem;\n}\n\n#main .project-header {\n    display: flex;\n    flex-direction: column;\n    gap: 0.5rem;\n}\n\n.project-header>.project-title {\n    font-size: 2.5rem;\n}\n\n.input-group-description {\n    position: relative;\n}\n\n.input-group-description .prompt {\n    color: var(--fade-color);\n    padding-left: 0.5rem;\n}\n\n.input-description {\n    background-color: var(--nav-color);\n    border-radius: 1em;\n    width: 100%;\n    height: 10ch;\n    padding: 0.5rem;\n    border: none;\n    resize: none;\n    font-family: inherit;\n}\n\n.input-title {\n    background-color: var(--nav-color);\n    border-radius: 0.5em;\n    width: 100%;\n    height: 1.5em;\n    padding: 0.5rem;\n    border: none;\n    resize: none;\n    font-family: inherit;\n}\n\n.input-todo-description {\n    border-radius: 0.5em;\n    width: 100%;\n    height: 10ch;\n    padding: 1ch;\n    border: none;\n    resize: none;\n    font-family: inherit;\n    margin-bottom: 0.7em;\n}\n\nbutton {\n    padding: 0.5rem 1.2rem;\n    float: right;\n    border-radius: 1em;\n}\n\n.save-btn {\n    background-color: var(--green);\n}\n\n.cancel-btn {\n    background-color: var(--red);\n    margin-right: 0.5rem;\n}\n\n.form-group {\n    display: flex;\n    flex-flow: column nowrap;\n    gap: 0.7em;\n    margin-bottom: 0.7em;\n}\n\n#todo-list{\n    display: flex;\n    flex-flow: column nowrap;\n    gap: 1.2em;\n}\n\n.todo{\n    background-color: var(--custom-white);\n    padding: 1.3em 1em;\n    border-radius: 1em;\n    width: 100%;\n    display: grid;\n    grid-template: auto auto / 1fr auto;\n    align-items: center;\n    gap: 1ch;\n}\n\n.add-todo-form {\n    background-color: var(--custom-white);\n    padding: 1.3em 1em;\n    border-radius: 1em;\n    width: 100%;\n    --nav-color: white;\n}\n\n.add-todo-form header {\n    font-size: 1.2em;\n    margin-bottom: 0.7em;\n}\n\n.add-todo-form .buttons{\n    display: flex;\n    justify-content: right;\n}\n\n.buttons button{\n    float: none;\n    gap: 0.5em;\n}\n\n.todo-title{\n    font-weight: bold;\n    font-size: 1.1em;\n}\n\n.todo-dueDate{\n    color: var(--fade-color);\n    font-size: 0.9em;\n    grid-row: -2 / -1;\n}\n\n.todo-dueDate .submit-btn{\n    margin-left: 0.5em;\n    padding: 0 0.5em;\n    background-color: var(--green);\n}\n\n.todo-checkbox{\n    width: 1.5em;\n    height: 1.5em;\n    grid-column: -2 /-1;\n}\n\n.todo-desc{\n    grid-column: 1 / -1;\n    padding: 0 0.5rem;\n}\n\n#page-footer {\n    background-color: var(--footer-color);\n}\n\n@media screen and (min-width: 650px) {\n    #page-header {\n        justify-content: center;\n    }\n\n    #nav-dropdown {\n        display: none;\n    }\n\n    #page-main {\n        display: grid;\n        grid-template: 1fr / 17.5rem 1fr;\n        grid-template-areas:\n            \"nav main\";\n    }\n\n    .todo {\n        grid-template: auto / 1fr auto auto;\n    }\n\n    .todo-dueDate {\n        grid-row: 1 / 2;\n        grid-column: -3 / -2;\n    }\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAEA;;;IAGI,SAAS;IACT,UAAU;IACV,sBAAsB;IACtB,kBAAkB;IAClB,cAAc;AAClB;;AAEA;IACI,uBAAuB;IACvB,uBAAuB;IACvB,mBAAmB;IACnB,oBAAoB;IACpB,uBAAuB;IACvB,qBAAqB;IACrB,cAAc;IACd,gBAAgB;IAChB,eAAe;IACf,iCAAiC;AACrC;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,UAAU;IACV,WAAW;AACf;;AAEA;IACI,wBAAwB;AAC5B;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,wBAAwB;AAC5B;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,YAAY;IACZ,iBAAiB;IACjB,iCAAiC;IACjC,aAAa;IACb,kCAAkC;AACtC;;AAEA;;IAEI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,0BAA0B;AAC9B;;AAEA;IACI,qCAAqC;IACrC,8BAA8B;IAC9B,eAAe;IACf,iBAAiB;AACrB;;AAEA;IACI,qCAAqC;IACrC,aAAa;IACb,YAAY;AAChB;;AAEA;IACI,cAAc;IACd,kCAAkC;IAClC,aAAa;IACb,aAAa;IACb,sBAAsB;IACtB,SAAS;IACT,iBAAiB;AACrB;;AAEA;IACI,gBAAgB;IAChB,iBAAiB;IACjB,oBAAoB;AACxB;;AAEA;IACI,eAAe;IACf,oBAAoB;IACpB,eAAe;IACf,aAAa;IACb,mBAAmB;IACnB,oBAAoB;IACpB,oCAAoC;IACpC,WAAW;AACf;;AAEA;IACI,YAAY;IACZ,6BAA6B;IAC7B,YAAY;IACZ,0BAA0B;IAC1B,iBAAiB;IACjB,iBAAiB;IACjB,oBAAoB;IACpB,oBAAoB;AACxB;;AAEA;IACI,iBAAiB;IACjB,iCAAiC;AACrC;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,2BAA2B;IAC3B,WAAW;AACf;;AAEA;IACI,oBAAoB;AACxB;;AAEA;IACI,yBAAyB;IACzB,cAAc;IACd,iBAAiB;AACrB;;AAEA;IACI,iBAAiB;IACjB,iBAAiB;AACrB;;AAEA;IACI,8BAA8B;AAClC;;AAEA;IACI,4BAA4B;AAChC;;AAEA;IACI,aAAa;IACb,+BAA+B;IAC/B,6BAA6B;IAC7B,SAAS;AACb;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,WAAW;AACf;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,wBAAwB;IACxB,oBAAoB;AACxB;;AAEA;IACI,kCAAkC;IAClC,kBAAkB;IAClB,WAAW;IACX,YAAY;IACZ,eAAe;IACf,YAAY;IACZ,YAAY;IACZ,oBAAoB;AACxB;;AAEA;IACI,kCAAkC;IAClC,oBAAoB;IACpB,WAAW;IACX,aAAa;IACb,eAAe;IACf,YAAY;IACZ,YAAY;IACZ,oBAAoB;AACxB;;AAEA;IACI,oBAAoB;IACpB,WAAW;IACX,YAAY;IACZ,YAAY;IACZ,YAAY;IACZ,YAAY;IACZ,oBAAoB;IACpB,oBAAoB;AACxB;;AAEA;IACI,sBAAsB;IACtB,YAAY;IACZ,kBAAkB;AACtB;;AAEA;IACI,8BAA8B;AAClC;;AAEA;IACI,4BAA4B;IAC5B,oBAAoB;AACxB;;AAEA;IACI,aAAa;IACb,wBAAwB;IACxB,UAAU;IACV,oBAAoB;AACxB;;AAEA;IACI,aAAa;IACb,wBAAwB;IACxB,UAAU;AACd;;AAEA;IACI,qCAAqC;IACrC,kBAAkB;IAClB,kBAAkB;IAClB,WAAW;IACX,aAAa;IACb,mCAAmC;IACnC,mBAAmB;IACnB,QAAQ;AACZ;;AAEA;IACI,qCAAqC;IACrC,kBAAkB;IAClB,kBAAkB;IAClB,WAAW;IACX,kBAAkB;AACtB;;AAEA;IACI,gBAAgB;IAChB,oBAAoB;AACxB;;AAEA;IACI,aAAa;IACb,sBAAsB;AAC1B;;AAEA;IACI,WAAW;IACX,UAAU;AACd;;AAEA;IACI,iBAAiB;IACjB,gBAAgB;AACpB;;AAEA;IACI,wBAAwB;IACxB,gBAAgB;IAChB,iBAAiB;AACrB;;AAEA;IACI,kBAAkB;IAClB,gBAAgB;IAChB,8BAA8B;AAClC;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,mBAAmB;IACnB,iBAAiB;AACrB;;AAEA;IACI,qCAAqC;AACzC;;AAEA;IACI;QACI,uBAAuB;IAC3B;;IAEA;QACI,aAAa;IACjB;;IAEA;QACI,aAAa;QACb,gCAAgC;QAChC;sBACc;IAClB;;IAEA;QACI,mCAAmC;IACvC;;IAEA;QACI,eAAe;QACf,oBAAoB;IACxB;AACJ","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap');\n\n*,\n*::before,\n*::after {\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n    font-size: inherit;\n    color: inherit;\n}\n\n:root {\n    --header-color: #1F3541;\n    --footer-color: #5289B5;\n    --bg-color: #AFD8F2;\n    --nav-color: #cee6f5;\n    --custom-white: #EDF2F3;\n    --fade-color: #505050;\n    --red: #ff6e6e;\n    --green: #bada55;\n    font-size: 16px;\n    font-family: \"Roboto\", sans-serif;\n}\n\nli::marker {\n    content: none;\n}\n\n.icon {\n    width: 1em;\n    height: 1em;\n}\n\n.display-none {\n    display: none !important;\n}\n\n.text-bold {\n    font-weight: bold;\n}\n\n.text-center {\n    text-align: center;\n}\n\n.text-fade {\n    color: var(--fade-color);\n}\n\n.float-right{\n    float: right;\n}\n\n#page-container {\n    width: 100vw;\n    min-height: 100vh;\n    background-color: var(--bg-color);\n    display: grid;\n    grid-template: 4rem 1fr 2rem / 1fr;\n}\n\n#page-header,\n#page-footer {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    color: var(--custom-white);\n}\n\n#page-header {\n    background-color: var(--header-color);\n    justify-content: space-between;\n    padding: 0 1rem;\n    font-size: 1.5rem;\n}\n\n#nav-dropdown {\n    background-color: var(--header-color);\n    outline: none;\n    border: none;\n}\n\n#nav {\n    grid-area: nav;\n    background-color: var(--nav-color);\n    padding: 1rem;\n    display: flex;\n    flex-direction: column;\n    gap: 1rem;\n    font-size: 1.2rem;\n}\n\n#nav header {\n    font-size: 1.3em;\n    font-weight: bold;\n    padding-bottom: 1rem;\n}\n\n#nav ul>li {\n    padding: 0.5rem;\n    border-radius: 0.5em;\n    cursor: pointer;\n    display: grid;\n    align-items: center;\n    justify-items: start;\n    grid-template-columns: auto 1fr auto;\n    gap: 0.5rem;\n}\n\n#nav button.delete-btn {\n    float: right;\n    background-color: transparent;\n    border: none;\n    color: var(--header-color);\n    font-size: 0.9rem;\n    font-weight: bold;\n    padding: 0.2em 0.3em;\n    border-radius: 0.2em;\n}\n\n#nav ul>li.active {\n    font-weight: bold;\n    background-color: var(--bg-color);\n}\n\n#add-project {\n    cursor: pointer;\n}\n\n#add-project-form {\n    display: grid;\n    grid-template-columns: 1fr 1fr;\n    grid-template-rows: 1fr 1fr;\n    gap: 0.5rem;\n}\n\n#add-project-form>* {\n    border-radius: 0.5em;\n}\n\n#add-project-form>input {\n    grid-area: 1 / 1 / 1 / -1;\n    padding: 2px 0;\n    padding-left: 1ch;\n}\n\n#add-project-form>button {\n    padding: 0.5rem 0;\n    font-weight: bold;\n}\n\n#add-project-btn {\n    background-color: var(--green);\n}\n\n#cancel-project-btn {\n    background-color: var(--red);\n}\n\n#main {\n    display: grid;\n    padding: clamp(1rem, 5vw, 3rem);\n    grid-template: auto 1fr / 1fr;\n    gap: 1rem;\n}\n\n#main .project-header {\n    display: flex;\n    flex-direction: column;\n    gap: 0.5rem;\n}\n\n.project-header>.project-title {\n    font-size: 2.5rem;\n}\n\n.input-group-description {\n    position: relative;\n}\n\n.input-group-description .prompt {\n    color: var(--fade-color);\n    padding-left: 0.5rem;\n}\n\n.input-description {\n    background-color: var(--nav-color);\n    border-radius: 1em;\n    width: 100%;\n    height: 10ch;\n    padding: 0.5rem;\n    border: none;\n    resize: none;\n    font-family: inherit;\n}\n\n.input-title {\n    background-color: var(--nav-color);\n    border-radius: 0.5em;\n    width: 100%;\n    height: 1.5em;\n    padding: 0.5rem;\n    border: none;\n    resize: none;\n    font-family: inherit;\n}\n\n.input-todo-description {\n    border-radius: 0.5em;\n    width: 100%;\n    height: 10ch;\n    padding: 1ch;\n    border: none;\n    resize: none;\n    font-family: inherit;\n    margin-bottom: 0.7em;\n}\n\nbutton {\n    padding: 0.5rem 1.2rem;\n    float: right;\n    border-radius: 1em;\n}\n\n.save-btn {\n    background-color: var(--green);\n}\n\n.cancel-btn {\n    background-color: var(--red);\n    margin-right: 0.5rem;\n}\n\n.form-group {\n    display: flex;\n    flex-flow: column nowrap;\n    gap: 0.7em;\n    margin-bottom: 0.7em;\n}\n\n#todo-list{\n    display: flex;\n    flex-flow: column nowrap;\n    gap: 1.2em;\n}\n\n.todo{\n    background-color: var(--custom-white);\n    padding: 1.3em 1em;\n    border-radius: 1em;\n    width: 100%;\n    display: grid;\n    grid-template: auto auto / 1fr auto;\n    align-items: center;\n    gap: 1ch;\n}\n\n.add-todo-form {\n    background-color: var(--custom-white);\n    padding: 1.3em 1em;\n    border-radius: 1em;\n    width: 100%;\n    --nav-color: white;\n}\n\n.add-todo-form header {\n    font-size: 1.2em;\n    margin-bottom: 0.7em;\n}\n\n.add-todo-form .buttons{\n    display: flex;\n    justify-content: right;\n}\n\n.buttons button{\n    float: none;\n    gap: 0.5em;\n}\n\n.todo-title{\n    font-weight: bold;\n    font-size: 1.1em;\n}\n\n.todo-dueDate{\n    color: var(--fade-color);\n    font-size: 0.9em;\n    grid-row: -2 / -1;\n}\n\n.todo-dueDate .submit-btn{\n    margin-left: 0.5em;\n    padding: 0 0.5em;\n    background-color: var(--green);\n}\n\n.todo-checkbox{\n    width: 1.5em;\n    height: 1.5em;\n    grid-column: -2 /-1;\n}\n\n.todo-desc{\n    grid-column: 1 / -1;\n    padding: 0 0.5rem;\n}\n\n#page-footer {\n    background-color: var(--footer-color);\n}\n\n@media screen and (min-width: 650px) {\n    #page-header {\n        justify-content: center;\n    }\n\n    #nav-dropdown {\n        display: none;\n    }\n\n    #page-main {\n        display: grid;\n        grid-template: 1fr / 17.5rem 1fr;\n        grid-template-areas:\n            \"nav main\";\n    }\n\n    .todo {\n        grid-template: auto / 1fr auto auto;\n    }\n\n    .todo-dueDate {\n        grid-row: 1 / 2;\n        grid-column: -3 / -2;\n    }\n}"],"sourceRoot":""}]);
// Exports
...
const EventAggregator = (function () {
  pubsub_js__WEBPACK_IMPORTED_MODULE_0___default().subscribe("ProjectAdded", (data) => {
    ...
    (0,_Utils__WEBPACK_IMPORTED_MODULE_5__.updateLocalStorage)(_Memory__WEBPACK_IMPORTED_MODULE_2__["default"]);
  ...
  pubsub_js__WEBPACK_IMPORTED_MODULE_0___default().subscribe("ChangeTodoDate", (id, date) => {
    const projectId = parseInt(
      document.querySelector("[data-projectId]").getAttribute("data-projectId")
    );
    const todo = _Memory__WEBPACK_IMPORTED_MODULE_2__["default"].getTodoId(projectId, id);
  ...
  pubsub_js__WEBPACK_IMPORTED_MODULE_0___default().subscribe("AddTodo", (projectId, todoTitle, todoDesc) => {
    const newTodo = (0,_Todo__WEBPACK_IMPORTED_MODULE_4__["default"])(todoTitle);
    const project = _Memory__WEBPACK_IMPORTED_MODULE_2__["default"].getProjectId(projectId);
...
const MainControl = (function () {
  ...
  const addTodo = (event) => {
    ...
    pubsub_js__WEBPACK_IMPORTED_MODULE_0___default().publish("AddTodo", [projectId, title, description]);
  };
...
const createAddTodoForm = (project) => {
  ...
  cancelBtn.addEventListener(
    "click",
    _Utils__WEBPACK_IMPORTED_MODULE_2__.displayDelete.bind(window, addTodoBtn, todoPrompt)
  );
  ...
  todoPrompt.addEventListener("submit", _MainControl__WEBPACK_IMPORTED_MODULE_0__["default"].addTodo);

  addTodoBtn.addEventListener(
    "click",
    _Utils__WEBPACK_IMPORTED_MODULE_2__.displayDelete.bind(window, todoPrompt, addTodoBtn)
  );
...
const Memory = (function () {
  ...
  const addToProjects = (project) => {
    ...
    (0,_Utils__WEBPACK_IMPORTED_MODULE_2__.updateLocalStorage)(Memory);
  };
  ...
  const removeProjectId = (projectId) => {
    (0,_Utils__WEBPACK_IMPORTED_MODULE_2__.removeById)(projects, projectId);
    (0,_Utils__WEBPACK_IMPORTED_MODULE_2__.updateLocalStorage)(Memory);
  };
  ...
  const populate = (storage) => {
    ...
    storedProjects.forEach((project) => {
      const projectObj = (0,_Project__WEBPACK_IMPORTED_MODULE_0__["default"])(project.title);
      if (project.description) projectObj.setDescription(project.description);
      project.todoList.forEach((todo) => {
        const todoObj = (0,_Todo__WEBPACK_IMPORTED_MODULE_1__["default"])(todo.title);
...
const PageView = (function () {
  ...
  const init = () => {
    if ("projects" in localStorage) {
      _Memory__WEBPACK_IMPORTED_MODULE_3__["default"].populate(localStorage);
    } else {
      const homeProject = (0,_Project__WEBPACK_IMPORTED_MODULE_4__["default"])("Home");
      const firstTodo = (0,_Todo__WEBPACK_IMPORTED_MODULE_5__["default"])("I'm a todo lol");
      ...
      homeProject.addTodo((0,_Todo__WEBPACK_IMPORTED_MODULE_5__["default"])("Another test todo"));
      _Memory__WEBPACK_IMPORTED_MODULE_3__["default"].addToProjects(homeProject);
      _Memory__WEBPACK_IMPORTED_MODULE_3__["default"].addToBookmarked(homeProject.id);

      const testProject = (0,_Project__WEBPACK_IMPORTED_MODULE_4__["default"])("Test Project");
      _Memory__WEBPACK_IMPORTED_MODULE_3__["default"].addToProjects(testProject);
    }
...
const TodoControl = (function () {
  ...
  const submitDueDate = (event) => {
    ...
    pubsub_js__WEBPACK_IMPORTED_MODULE_0___default().publish("ChangeTodoDate", [parseInt(todoId), date]);
  };
...
const createDueDate = (todo) => {
  ...
  if (todo.dueDate) {
    ...
    const now = new Date();
    const hasPassed = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(due, now) !== -1;
    prompt.textContent = `${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(
      new Date(todo.dueDate),
      "do MMM yyyy"
    )} (${(0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(todo.dueDate), new Date())} ${
      hasPassed ? "ago" : "left"
    })`;
  ...
  prompt.addEventListener("click", _Utils__WEBPACK_IMPORTED_MODULE_1__.displayDelete.bind(window, input, prompt));
  input.addEventListener("submit", _TodoControl__WEBPACK_IMPORTED_MODULE_0__["default"].submitDueDate);
  return dueDate;
};
